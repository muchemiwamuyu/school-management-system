          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-800">Mathematics - Grade 10</p>
                  <p className="text-sm text-gray-500">24 students • Room 205</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-sm font-medium text-gray-600">Next: 9:00 AM</p>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-800">Chemistry - Grade 11</p>
                  <p className="text-sm text-gray-500">18 students • Lab 3</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-sm font-medium text-gray-600">Next: 11:30 AM</p>
                <p className="text-xs text-gray-500">Today</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-medium text-gray-800">Physics - Grade 12</p>
                  <p className="text-sm text-gray-500">22 students • Room 301</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-sm font-medium text-gray-600">Next: 2:00 PM</p>
